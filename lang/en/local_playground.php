...
$string["createsandbox"] = "Create Playground";
$string["create_sandbox_course"] = "Create my playground course";
...
$string["not_allowed"] = "You do not have permission to view this page.";
...
$string["sandbox_completed_text"] = "Your new playground course has been created. Click the button below to access your course.<br>";
$string["sandbox_course_creation"] = "Your playground course is being created.";
$string["sanbox_course_name"] = "Playground course";
